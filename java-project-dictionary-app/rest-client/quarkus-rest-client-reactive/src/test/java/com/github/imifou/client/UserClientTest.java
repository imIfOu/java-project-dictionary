...
public class UserClientTest {
    ...
    void testCreateUser_whenResponseIsBadRequestInvalidErrorFormat() {
        ...
        var user = buildDefaultUser();
        BadRequestResponseException exception = (BadRequestResponseException) userClient.createUser(user)
                .subscribe()
                .withSubscriber(UniAssertSubscriber.create())
                .awaitFailure()
                .assertFailedWith(BadRequestResponseException.class)
    ...
    void testUpdateUser_whenResponseIsNotFoundInvalidErrorFormat() {
        ...
        var user = buildDefaultUser();
        NotFoundResponseException exception = (NotFoundResponseException) userClient.updateUser(USER_ID, user)
                .subscribe()
                .withSubscriber(UniAssertSubscriber.create())
                .awaitFailure()
                .assertFailedWith(NotFoundResponseException.class)
    ...
    void testUpdateUser_whenResponseIsBadRequestInvalidErrorFormat() {
        ...
        var user = buildDefaultUser();
        BadRequestResponseException exception = (BadRequestResponseException) userClient.updateUser(USER_ID, user)
                .subscribe()
                .withSubscriber(UniAssertSubscriber.create())
                .awaitFailure()
                .assertFailedWith(BadRequestResponseException.class)
